...
<div class="wrapper">
    ...
    <header class="main-header">
        ...
        <a href="../../index2.html" class="logo">
            ...
            <span class="logo-mini"><b>SD</b>IPVC</span>
            <!-- logo for regular state and mobile devices -->
            <span class="logo-lg"><b>Secretaria</b>IPVC</span>
        </a>
                    ...
                    @auth
                        <li class="dropdown user user-menu">
                            <a href="#" class="dropdown-toggle" data-toggle="dropdown">
                                <img src="@if(Auth::user()->sexo == 'f'){{ asset('dist/img/avatar2.png') }} @else {{ asset('dist/img/avatar04.png') }} @endif"
                            ...
                            <ul class="dropdown-menu">
                                ...
                                <li class="user-header">
                                    ...
                                    @endif
                                    <p>
                                        {{ Auth::user()->name }} {{ Auth::user()->apellidos }} - {{ Auth::user()->rol }}
                                        <small>{{ Auth::user()->created_at->format('Y') }}</small>
                                    </p>
                                </li>
                                <!-- Menu Footer-->
    ...
    <aside class="main-sidebar">
        ...
        <section class="sidebar">
            ...
            <ul class="sidebar-menu" data-widget="tree">
                <li class="header">MI NAVEGACIÓN</li>
